...
public class UserBusinessRules : BaseBusinessRules
{
    ...
    public Task UserShouldBeExistsWhenSelected(Core.Security.Entities.User? user)
    {
        if (user == null)
    ...
    public Task UserPasswordShouldBeMatched(Core.Security.Entities.User user, string password)
    {
